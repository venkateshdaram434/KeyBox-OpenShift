        ...
        $(document).ready(function () {
            ...
            $(document).keydown(function (e) {
                if (termFocus) {
                    ...
                    //35 - END
                    //36 - HOME
                    if (keys[27] || keys[37] || keys[38] || keys[39] || keys[40] || keys[13] || keys[8] || keys[9] || keys[17] || keys[46] || keys[45] || keys[33] || keys[33] || keys[34]|| keys[35] || keys[36]) {
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a id="connect_to_host" data-toggle="modal" data-target="#connect_to_host_dialog" href="#">Connect to Gear</a></li>
...
<div class="term-container container">
    ...
    <div id="connect_to_host_dialog" class="modal fade modal-wide">
